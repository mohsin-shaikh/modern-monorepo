  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on ZUUPEE`,
        "invite.preview": `Join ${params?.teamName} on ZUUPEE`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på ZUUPEE`,
        "invite.preview": `Gå med i ${params?.teamName} på ZUUPEE`,
...
var InviteEmail = ({
  invitedByEmail = "mohsin@zuupee.com",
  invitedByName = "Mohsin Shaikh",
  email = "mohsin@zuupee.com",
  teamName = "Acme Co",
      ...
      Container,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Heading, { className: "mx-0 my-[30px] p-0 text-[24px] font-normal text-[#121212] text-center", children: [
            ...
            t("invite.title2"),
            " ",
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("strong", { children: "ZUUPEE" }, void 0, false, {
              fileName: "../../packages/email/emails/invite.tsx",
              lineNumber: 82,
              columnNumber: 36
            })
